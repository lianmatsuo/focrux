...
| [0018](0018-defer-custom-ide-until-evidence-gates.md) | Focrux reads code; editing stays in the person's editor |
...
| [0027](0027-own-the-ticket-natively.md) | Focrux owns admitted tickets; one authoritative source per field |
...
| [0035](0035-rename-the-product-to-focrux.md) | The product is Focrux everywhere |
