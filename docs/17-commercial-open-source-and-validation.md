...
- **Trademarks and patents:** Apache-2.0's own terms and nothing beyond them. It grants no trademark rights and carries its own patent licence. The Focrux name, logo and artwork are not licensed under Apache-2.0; `NOTICE` says which files ([D-112](11-open-decisions.md)).
...
Focrux is judged by real use ([D-099](11-open-decisions.md)):
- `focrux stops` reads precision of stopping live ([D-060](11-open-decisions.md));
- `focrux escapes` reads what merged and was later undone;
