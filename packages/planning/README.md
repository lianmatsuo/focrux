...
| `authored.ts` | `issueAuthoredAttempts`: the completion claims and the lines addressed to the drafter, quoted with the line numbers of the source they were read from, and counted in full even when the listing is capped |
